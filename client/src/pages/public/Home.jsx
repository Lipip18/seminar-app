  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-20">
        <Link 
          to="/login" 
          className="px-8 py-3 rounded-xl bg-secondary text-white font-semibold hover:bg-secondary/90 transition-all shadow-md transform hover:-translate-y-1"
        >
          Login
        </Link>
        <Link 
          to="/register" 
          className="px-8 py-3 rounded-xl border border-gray-300 bg-white hover:bg-gray-50 text-gray-800 font-semibold transition-all transform hover:-translate-y-1 shadow-sm"
        >
          Create Account
        </Link>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-6xl mb-20">
        <div className="glass-panel p-8 text-left hover:border-secondary/30 transition-colors">
          <div className="h-12 w-12 rounded-xl bg-indigo-50 border border-indigo-100 flex items-center justify-center mb-6">
            <svg className="w-6 h-6 text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
          </div>
          <h3 className="text-2xl font-semibold mb-3 text-primary">Real-time Booking</h3>
        ...
        <div className="glass-panel p-8 text-left hover:border-secondary/30 transition-colors">
          ...
          <h3 className="text-2xl font-semibold mb-3 text-primary">Role Based Access</h3>
        ...
        <div className="glass-panel p-8 text-left hover:border-secondary/30 transition-colors">
          <div className="h-12 w-12 rounded-xl bg-indigo-50 border border-indigo-100 flex items-center justify-center mb-6">
            <svg className="w-6 h-6 text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg>
          </div>
          <h3 className="text-2xl font-semibold mb-3 text-primary">Rich Amenities</h3>
